...
___
Модуль для работы с сущностями личных диалогов в БД.
___
...
```kotlin
implementation(project(":bm-domain:bm-direct:bm-direct-db"))
```
...
bm-direct-db:
  liquibase:
    changelog: classpath:db/changelog/db.changelog-master-direct.yaml
