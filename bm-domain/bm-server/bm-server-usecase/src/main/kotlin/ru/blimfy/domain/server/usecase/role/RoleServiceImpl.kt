...
import ru.blimfy.domain.server.api.enumerations.Permissions
import ru.blimfy.domain.server.api.enumerations.Permissions.entries
import ru.blimfy.domain.server.db.entity.MemberRole
import ru.blimfy.domain.server.db.entity.Role
import ru.blimfy.domain.server.db.repository.MemberRoleRepository
import ru.blimfy.domain.server.db.repository.RoleRepository
import ru.blimfy.domain.server.usecase.member.MemberService
import ru.blimfy.server.usecase.exception.ServerErrors.DEFAULT_ROLE_NOT_FOUND
import ru.blimfy.server.usecase.exception.ServerErrors.ROLE_NOT_FOUND
