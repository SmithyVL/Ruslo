package ru.blimfy.domain.server.usecase.member
...
import ru.blimfy.domain.server.db.repository.MemberRepository
...
import ru.blimfy.server.usecase.exception.ServerErrors.MEMBER_NOT_FOUND
