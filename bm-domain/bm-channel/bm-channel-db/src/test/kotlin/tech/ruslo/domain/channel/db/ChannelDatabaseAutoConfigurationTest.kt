package tech.ruslo.domain.channel.db
...
/**
 * Тестирование поднятия spring контекста для модуля.
 *
 * @author Владислав Кузнецов.
 * @since 0.0.1.
 */
@SpringBootTest(classes = [ChannelDatabaseAutoConfiguration::class], webEnvironment = NONE)
@EnableAutoConfiguration
class ChannelDatabaseAutoConfigurationTest {
    @Test
