...
___
Модуль для работы с сущностями пользователей и их паролей в БД.
___
...
```kotlin
implementation(project(":bm-domain:bm-user:bm-user-db"))
```
...
bm-user-db:
  liquibase:
    ...
    changelog: classpath:db/changelog/db.changelog-master-user.yaml
