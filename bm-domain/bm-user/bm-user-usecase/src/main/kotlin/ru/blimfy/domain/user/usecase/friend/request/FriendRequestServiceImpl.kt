package ru.blimfy.domain.user.usecase.friend.request

import java.util.UUID
import org.springframework.stereotype.Service
import ru.blimfy.common.exception.NotFoundException
import ru.blimfy.domain.user.db.entity.FriendRequest
import ru.blimfy.domain.user.db.repository.FriendRequestRepository
import ru.blimfy.domain.user.usecase.exception.UserErrors.FRIEND_REQUEST_NOT_FOUND
