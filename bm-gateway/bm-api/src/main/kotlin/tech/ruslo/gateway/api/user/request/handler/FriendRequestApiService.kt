package tech.ruslo.gateway.api.user.request.handler
...
interface FriendRequestApiService {
    /**
     * Возвращает новый запрос в друзья с пользователем с [username] для [user].
     */
    suspend fun createFriendRequest(username: String, user: User): FriendRequestDto
