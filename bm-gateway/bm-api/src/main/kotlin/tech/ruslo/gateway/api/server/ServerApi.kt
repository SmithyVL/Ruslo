package tech.ruslo.gateway.api.server
...
import tech.ruslo.gateway.api.server.handler.ServerApiService
...
class ServerApi(private val service: ServerApiService) {
    ...
    suspend fun modifyChannelPositions(
        @PathVariable id: UUID,
        @RequestBody positions: List<ChannelPositionDto>,
        @AuthenticationPrincipal userDetails: CustomUserDetails,
    ) = service.modifyChannelPositions(id, positions, userDetails.info)
