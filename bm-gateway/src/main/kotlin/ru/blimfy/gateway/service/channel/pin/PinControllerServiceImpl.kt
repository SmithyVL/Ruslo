 ...
 */
@Service
class PinControllerServiceImpl(
    private val messageService: MessageService,
    private val channelService: ChannelService,
    private val serverService: ServerService,
    private val userService: UserService,
    private val userWsStorage: UserWebSocketStorage,
) : PinControllerService {
    override suspend fun findPins(channelId: UUID, pageNumber: Int, pageSize: Int, user: User): Flow<MessageDto> {
        checkMessageViewAccess(id = channelId, userId = user.id)

        return messageService.findPinnedMessages(channelId, pageNumber, pageSize)
