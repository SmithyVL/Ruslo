...
/**
 * DTO с обновлённой информацией о текстовом сообщении канала.
 *
 ...
 * @since 0.0.1.
 */
data class ModifyTextMessageDto(val channelId: UUID, val content: String, val fileUrl: String? = null)

/**
 * Возвращает сущность текстового сообщения канала сервера из DTO представления текстового сообщения канала сервера.
 */
fun ModifyTextMessageDto.toEntity(authorId: UUID) =
